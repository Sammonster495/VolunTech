    ...
    return (
        <GestureHandlerRootView>
            <ScrollView style={{backgroundColor:theme === 'light' ? '#f6ffe2' : '#1e1e1e'}} className=" min-h-screen">
                ...
                <TextInput style={{backgroundColor:theme === 'light' ? 'white' : 'black',borderWidth:1,borderColor:theme === 'light' ? 'black' : 'white' }} placeholderTextColor={theme === 'light' ? 'grey' : '#d9d9d9'} placeholder="Add a description..." className="w-[80%] h-32 border text-lg self-center mt-8 px-2" onChangeText={(text) => setDescription(text)} />
